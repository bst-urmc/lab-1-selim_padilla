...
DataSaurus Dozen has 1846 rows and 3 variables. Given the format of Datasaurus Dozen, there are 3 variables: x values,y-values , and dataset which indicates the data are from.
